    ...
    <>
      <View className=" px-3">
        <Pressable className="flex flex-row items-center gap-x-1" onPress={filtersHandlers.open}>
          ...
          <Text className="text-base text-neutral-600">Dépistage</Text>
        </Pressable>
      </View>
      <Modal
        isShow={isFilters}
      ...
      >
        ...
        >
          <Modal.Header onClose={filtersHandlers.close}> Filtre </Modal.Header>
          <Modal.Body>
            ...
            <View className="divide-y">
              <View className="flex flex-row justify-between items-center py-2.5">
                <Text className="font-medium text-gray-700 w-3/4">
              ...
              <View className="flex flex-row justify-between items-center py-2.5">
                <Text className="font-medium text-gray-700 w-3/4">Offre spéciale uniquement</Text>
                <Switch
              ...
              <View className="py-4">
                <Text className="font-medium text-gray-700">Fourchette de prix</Text>
                <View className="flex flex-row items-center justify-between gap-x-1">
                  <Text className="text-base">A partir de</Text>
                ...
                <View className="flex flex-row items-center justify-between mt-2 mb-4 gap-x-1">
                  <Text className="text-base">Jusqu'a</Text>
