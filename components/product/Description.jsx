...
const Description = props => {
  ...
  return (
    <Pressable>
      <View className="px-3">
        <Text className="mb-3 lg:border-b-2 lg:border-red-500 w-fit">Présenter</Text>
        ...
        {description.length > 300 && (
          ...
          >
            {isShowDesc ? (
              <Text className="text-sm text-sky-400">Mettre de côté</Text>
            ) : (
              <Text className="text-sm text-sky-400">Voir plus</Text>
            )}
            {!isShowDesc && (
