  ...
  return (
    <View className="px-4 pt-4">
      <View className="lg:max-w-3xl xl:max-w-5xl">
        <Text className="mb-3 h-fit w-fit">Spécifications</Text>
        ...
        <View className="l">
          ...
          {specification.length > 7 && (
            ...
            >
              {isShowSpec ? (
                <Text className="text-sm text-sky-400">Fermer</Text>
              ) : (
                <Text className="text-sm text-sky-400">Afficher davantage</Text>
              )}
              {!isShowSpec && (
                <Icons.MaterialIcons
