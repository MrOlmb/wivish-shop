    ...
    <>
      <View className="px-3 py-3 space-y-4" id="_productReviews">
        <View className="flex flex-row items-center justify-between">
          <Text className="">Avis sur le produit</Text>
          <Text className="text-xs text-sky-500">{numReviews} Commentaires</Text>
        </View>
        <View className="mb-2">
          <Pressable
          ...
          >
            ...
            <Text className="text-sm text-black ml-2">Écrivez votre avis sur ce produit</Text>
            <Icons.MaterialIcons name="keyboard-arrow-right" size={24} className="ml-auto icon" />
          </Pressable>
          <Text className="mt-6 text-xs text-gray-500">
            Après confirmation de la soumission, des points seront offerts。
          </Text>
        </View>
        <ShowWrapper
          error={error}
