  ...
  return (
    <>
      ...
      <Modal isShow={isShow} onClose={onClose} effect="bottom-to-top" className="m-0">
        ...
        >
          <Modal.Header onClose={onClose}>Gestion des adresses</Modal.Header>
          <Modal.Body>
            <Text>Veuillez saisir votre adresse de livraison</Text>
              ...
              <View className="space-y-2">
                <View className="space-y-2">
                  <Combobox
                    ...
                    name="province"
                    list={AllProvinces}
                    placeholder="Veuillez sélectionner votre province"
                  />
                ...
                <View className="space-y-2 ">
                  <Combobox
                    ...
                    name="city"
                    list={cities}
                    placeholder="Veuillez sélectionner votre ville"
                  />
                ...
                <View className="space-y-2 ">
                  <Combobox
                    ...
                    name="area"
                    list={areas}
                    placeholder="Veuillez sélectionner votre district"
                  />
                  <DisplayError errors={formErrors.area?.name} />
                </View>

                <TextField
                  label="Informations sur les rues"
                  control={control}
