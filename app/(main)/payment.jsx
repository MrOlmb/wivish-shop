...
export default function PaymentScreen() {
  ...
  const handleCreateOrder = () => {
    if (
      ...
      return Toast.show({
        type: 'error',
        text2: 'Veuillez indiquer votre adresse',
      })
    else
      postData({
        body: {
  ...
  return (
    <>
      <Stack.Screen
        options={{
          title: `Remplir le formulaire de commande`,
            ...
            <View className="py-2 space-y-3">
                ...
                <View className="flex flex-row items-center justify-evenly">
                  <Link href="/cart" asChild>
                    <Pressable className="flex flex-col items-center gap-y-2">
                      ...
                      />
                      <Text className="font-normal text-red-300">Chariot</Text>
                    </Pressable>
                  </Link>
                  ...
                  <View className="flex flex-col items-center gap-y-2">
                    ...
                    />
                    <Text className="text-base font-normal text-red-500">
              ...
              <View className="flex flex-row items-center px-3 py-4 gap-x-3">
                ...
                {userInfo?.address ? (
                  ...
                  <Text className="text-black">Completer l'adresse</Text>
                )}
                <ChangeAddress />
              </View>
              <View className="section-divide-y h-2 bg-gray-100" />
              ...
              <View className="px-2 py-4 mx-3 border border-gray-200 rounded-lg">
                <View className="flex flex-row items-start mb-5">
                  ...
                  />
                  <View>
                    <Text className="text-base text-black">Expedition normale</Text>
                    <Text className="block text-neutral-600">En stock</Text>
                  </View>
                  <View className="inline-block px-2 py-1 ml-3 bg-gray-100 rounded-lg h-auto">
                    <Text className="text-neutral-600">{formatNumber(totalItems)} Articles</Text>
                  </View>
                </View>
              ...
              <View className="lg:border lg:border-gray-200 lg:rounded-md lg:h-fit">
                ...
                <View className="px-3 py-2 space-y-3">
                  <RadioButton.Group
                    ...
                    value={paymentMethod}
                  >
                    <RadioButton.Item label="Paiement en ligne" value="Paiement en ligne" />
                    <RadioButton.Item label="Carte bancaire" value="Carte bancaire" />
                  </RadioButton.Group>
                </View>
              </View>
            </View>
